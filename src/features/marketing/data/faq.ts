...
export const faqItems: FaqItem[] = [
  {
    ...
    answer:
      "Resonance is an AI-powered text-to-speech platform. Write or paste any text, pick a voice, and generate natural-sounding audio in seconds — for stories, ads, podcasts, games, and more.",
  },
  {
    question: "Can I clone my own voice?",
    answer:
      "Yes. Upload a short voice sample and Resonance creates a custom voice you can use across all your generations. Your cloned voices stay private to your organization.",
  },
  {
    question: "How does pricing work?",
    answer:
      "Resonance uses pay-as-you-go billing. Speech generation starts at $0.30 per 1,000 characters, so you only pay for what you use — no subscriptions required.",
  },
  {
